...
2) Build the Power Automate Flow (Trigger + Response Details)
...
3) Normalize Inputs + Build User Values (UPN / Display Name / Mail Nickname)
...
- Confirm the flow executes identity actions in Entra ID without manual input.
...
7) Validate Results in Entra ID
